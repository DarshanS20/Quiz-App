...
public class QuizStart extends JFrame {
	...
	public QuizStart(String username) {
		...
		lblNewLabel.setBounds(138, 96, 715, 99);
		...
		label_1.setBounds(719, 32, 77, 60);
		contentPane.add(label_1);
		
		JLabel lblNewLabel_2 = new JLabel("  USN : ");
		lblNewLabel_2.setBackground(new Color(255, 127, 80));
		lblNewLabel_2.setOpaque(true);

		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 21));
		lblNewLabel_2.setBounds(0, 10, 126, 57);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblMin = new JLabel("Min");
		lblMin.setFont(new Font("Tahoma", Font.PLAIN, 21));
		lblMin.setBounds(678, 0, 90, 53);
		contentPane.add(lblMin);
		
		JLabel lblSec = new JLabel("Sec");
		lblSec.setFont(new Font("Tahoma", Font.PLAIN, 21));
		lblSec.setBounds(719, 0, 90, 53);
		...
		label_2.setBackground(new Color(255, 127, 80));
		label_2.setFont(new Font("Tahoma", Font.PLAIN, 21));
		label_2.setBounds(0, 60, 126, 512);
		contentPane.add(label_2);
		
		JLabel label_3 = new JLabel("");
		label_3.setBackground(new Color(255, 127, 80));
		label_3.setOpaque(true);
		label_3.setFont(new Font("Tahoma", Font.PLAIN, 21));
		label_3.setBounds(0, 0, 126, 24);
		...
		lblNewLabel_3.setBounds(124, 106, 812, 285);
